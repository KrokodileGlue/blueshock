...
#define SCALE 3.0
#define SPEED (iGlobalTime * (155.0 / 60.0) * 1.0)
#define XOFF 3.0
#define YOFF 2.0
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    //vec2 mouse = vec2(sin(SPEED)*(1.0/SCALE)*4.0, cos(SPEED)*(1.0/SCALE)*4.0);
    ...
    vec2 mouse = vec2(sin(SPEED)*(1.0/SCALE)*(SCALE+XOFF), cos(SPEED)*(1.0/SCALE)*(SCALE+YOFF));
    mouse *= rot;
